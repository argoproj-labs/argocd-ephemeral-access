...
func (in *AccessRequestStatus) DeepCopyInto(out *AccessRequestStatus) {
	*out = *in
	...
	if in.History != nil {
		...
		*out = make([]AccessRequetsHistory, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccessRequetsHistory) DeepCopyInto(out *AccessRequetsHistory) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessRequetsHistory.
func (in *AccessRequetsHistory) DeepCopy() *AccessRequetsHistory {
	if in == nil {
		return nil
	}
	out := new(AccessRequetsHistory)
	in.DeepCopyInto(out)
	return out
}
